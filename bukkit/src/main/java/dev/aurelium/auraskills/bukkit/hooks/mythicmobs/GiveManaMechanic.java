...
@MythicMechanic(name = "giveMana")
public class GiveManaMechanic implements ITargetedEntitySkill {

    private final AuraSkills plugin;
    private final double manaToTake;

    public GiveManaMechanic(AuraSkills plugin, MythicMechanicLoadEvent loader) {
        this.plugin = plugin;
    ...
    public SkillResult castAtEntity(SkillMetadata data, AbstractEntity target) {
        ...
        user.setMana(Math.min(user.getMaxMana(),user.getMana() + manaToTake));
